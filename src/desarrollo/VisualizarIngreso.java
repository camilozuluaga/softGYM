 ...
 * @author Usuario
 */
public class VisualizarIngreso extends javax.swing.JInternalFrame {

    /**
     * Creates new form VisualizarIngreso
     */
    public VisualizarIngreso(String id_ingreso, String descripcion, Double valor) {
        initComponents();
        txtDescripcion.setText(descripcion);
        txtCantidad.setText(String.valueOf(valor));
        lblId.setText(id_ingreso);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle("Visualizar Ingreso");

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setText("Visualizar Ingreso de Caja");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtDescripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 317, Short.MAX_VALUE)
