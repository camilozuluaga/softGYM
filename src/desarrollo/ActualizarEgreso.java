 ...
 * @author GID
 */
public class ActualizarEgreso extends javax.swing.JInternalFrame {

    /**
     * Creates new form internalEjemplo
     */
    private DB db = new DB();
    AdministrarEgresos parent;

    public ActualizarEgreso(AdministrarEgresos parent) {
        this.parent = parent;
        initComponents();
    }

    public ActualizarEgreso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnGuardar.setText("Registrar Egreso");
        ...
        jLabel1.setText("Administrar Movimientos de Caja (Egresos)");
