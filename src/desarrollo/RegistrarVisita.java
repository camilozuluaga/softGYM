...
public class RegistrarVisita extends javax.swing.JInternalFrame {
    ...
    public RegistrarVisita(Puerta pp, String primerNombre, String segundoNombre, String primerApellido, String segundoApellido, String socioId, String token) {
        ...
        txtPriApellido.setText(primerApellido);
        txtSegApellido.setText(segundoApellido);
    ...
    private void initComponents() {
        ...
        cToken = new javax.swing.JTextField();
        ...
        cToken.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        cToken.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cTokenActionPerformed(evt);
            }
        });
        cToken.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                cTokenKeyReleased(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtCosto, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
                            .addComponent(cToken, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(52, 52, 52)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        int tamanoValor = txtCosto.getText().length();
        ...
        if (tamanoValor <= 6) {
            try {
                ...
                if (validacion == false) {
                    JOptionPane.showMessageDialog(this, "NO SE HA REGISTRADO LA VISITA", "REGISTRANDO VISITA", JOptionPane.WARNING_MESSAGE);
                    Telegraph tele = new Telegraph("Cierre Caja", "No se pudo registrar la visita. \n La fecha actual es menor que la fecha de apertura", TelegraphType.NOTIFICATION_WARNING, WindowPosition.TOPRIGHT, 9000);
            ...
            Telegraph tele = new Telegraph("REGISTRO VISITA", "NO SE HA PODIDO CREAR LA VISITA \n HA SOBREPASASO EL VALOR DEL PAGO DE LAS VISITAS", TelegraphType.NOTIFICATION_ERROR, WindowPosition.TOPRIGHT, 5000);
            TelegraphQueue q = new TelegraphQueue();
            q.add(tele);
            txtCosto.setText("");
        }
    ...
    private void cTokenKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cTokenKeyReleased
        if (evt.getKeyChar() == KeyEvent.VK_ENTER) {
            if (!cToken.getText().isEmpty()) {
                try {
                    //Traer datos del socio y posicionar foco en el valor
                    String query = String.format("SELECT id,primer_nombre,segundo_nombre,primer_apellido,segundo_apellido,identificacion FROM socio where clave = '%s'", cToken.getText());
                    ResultSet datosQuery = db.sqlDatos(query);
                    while (datosQuery.next()) {
                        socioId = datosQuery.getString(1);
                        txtPriNombre.setText(datosQuery.getString(2));
                        txtSegNombre.setText(datosQuery.getString(3));
                        txtPriApellido.setText(datosQuery.getString(4));
                        txtSegApellido.setText(datosQuery.getString(5));
                        txtIdentificacion.setText(datosQuery.getString(6));
                        txtCosto.requestFocus();
                    }
                } catch (SQLException ex) {
                    Logger.getLogger(RegistrarVisita.class.getName()).log(Level.SEVERE, "No se logro comprobar identidad de socio", ex);
                }
            }
        }
    }//GEN-LAST:event_cTokenKeyReleased
    ...
    private void cTokenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cTokenActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cTokenActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnGuardar;
    private javax.swing.JTextField cToken;
    ...
    private void guardar() {
        ...
        if ((txtPriNombre.getText().isEmpty()) && (txtPriApellido.getText().isEmpty()) && (txtCosto.getText().isEmpty())) {
            ...
            // Si se identifica que es un socio guardar el id del socio correspondiente
            if (!socioId.isEmpty()) {
                querySQL = String.format("INSERT INTO pago_visita(usuario_sistema_id, nombres, apellidos, costo, fecha_registro,socio_id) VALUES (%s,'%s','%s',%s,now(),%s)", usuario_id, nombres, apellidos, costo, socioId);
            }
