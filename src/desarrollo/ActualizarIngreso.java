 ...
 * @author GID
 */
public class ActualizarIngreso extends javax.swing.JInternalFrame {

    /**
     * Creates new form internalEjemplo
     */
    private DB db = new DB();
    AdministrarIngresos parent;

    public ActualizarIngreso(AdministrarIngresos parent) {
        this.parent = parent;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnGuardar.setText("Registrar Ingreso");
        ...
        jLabel1.setText("Registrar Movimientos de Caja (Ingresos)");
